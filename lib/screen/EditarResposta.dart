...
class EditarResposta extends StatefulWidget {
  Resposta resposta;

  EditarResposta({ this.resposta });

  @override
  _EditarRespostaState createState() => _EditarRespostaState();
}

class _EditarRespostaState extends State<EditarResposta> {
  TextEditingController conteudoController;

  void initialize() {
    this.conteudoController = new TextEditingController(text: this.widget.resposta.conteudo);
  }

  RespostaService service = new RespostaService( prefix: ApiUrls.prefix, host: ApiUrls.hostqst, path: "qst/answers");

  void submit(context) async {
    this.widget.resposta.conteudo = this.conteudoController.text;

    await service.updateResposta(id: this.widget.resposta.id, resposta: this.widget.resposta);
